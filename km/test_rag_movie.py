...
COLLECTION_NAME = "test_movie"

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(SCRIPT_DIR)

TXT_DIR = os.path.join(PROJECT_ROOT, "movie", "chinese")
GOLDEN_QA_FILE = os.path.join(PROJECT_ROOT, "movie", "Movie_QA.txt")
